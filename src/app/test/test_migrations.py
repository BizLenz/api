...
class TestMigrations:
    ...
    def test_upgrade_creates_tables(self, temp_engine, alembic_config):
        ...
        with temp_engine.connect() as connection:
            ...
            assert expected_tables.issubset(tables), f"Expected tables not created: {expected_tables}"
    ...
    def test_upgrade_downgrade_cycle(self, temp_engine, alembic_config):
        ...
        with temp_engine.connect() as connection:
            ...
            # 테이블이 추가되었는지 확인
            assert len(after_upgrade) > len(initial_tables), "No tables created during upgrade"
            ...
            assert user_tables_after_downgrade == initial_tables, "Downgrade didn't restore original state"