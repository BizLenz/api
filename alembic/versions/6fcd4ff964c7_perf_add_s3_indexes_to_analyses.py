...
def downgrade() -> None:
    ...
    # 인덱스 제거 (역순)
    op.drop_index('idx_analyses_presigned_expires', 'analyses')
    op.drop_index('idx_analyses_upload_completed_desc', 'analyses')
    op.drop_index('idx_analyses_last_accessed_desc', 'analyses')
    op.drop_index('idx_analyses_s3_bucket_key', 'analyses')
    op.drop_index('idx_analyses_archived_status', 'analyses')
    op.drop_index('idx_analyses_download_count_desc', 'analyses')
